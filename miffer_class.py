...
class Plocha:
    ...
    def table (self, args):
        ...
        pay = Button(self.new_frame, text = 'Karta', relief = FLAT, bg = "#006080", fg = "white", command = self.pay)
        pay_w_cash = Button(self.new_frame, text = 'Hotovosť', relief = FLAT, bg = "#006080", fg = "white", command = self.pay_cash)
...
'''
        ...
        self.file1.close()
        num += 1 
        self.paid = requests.post('miffer.000webhostapp.com/dokoncenieobjednavky.php', json={'stol': args + 1, 'cena': self.table_order_price.json()[0]['cena']})
      # card pay method
